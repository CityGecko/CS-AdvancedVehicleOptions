...
namespace AdvancedVehicleOptionsUID
{
    ...
    {
        // Default language. Matches the language code derived from en.csv's filename.
        ...
        /// </summary>
        public string ActiveLanguageCode => ActiveLanguage.Code;
        ...
        /// <returns>Matched language code corresponding to a loaded translation file.</returns>
            ...
            foreach (string translationFile in translationFiles)
            {
                ...
                try
                {
                    ...
                    using (StreamReader reader = new StreamReader(fileStream))
                    {
                        ...
                        {
                            Logging.Message("read translation file ", translationFile, " with language ", thisLanguage.Code, " (", thisLanguage.Name, ") with ", addedEntries.ToString(), " added entries");
